...
# ----------------------------------------------------------------------
# Project imports (package module: src/dynamix/stat.py -> import as dynamix.stat)
# ----------------------------------------------------------------------
...
class _StatUnpickler(pickle.Unpickler):
    def find_class(self, module: str, name: str) -> Any:
        # Tolerate checkpoints pickled before stat.py moved into the package
        # (module was "__main__" or "stat" when run as a root script).
        if name == "RoundingMode" and module in ("__main__", "stat", __name__):
            return RoundingMode
